      ...
      <div className="w-full px-6 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-12 absolute left-1/2 transform -translate-x-1/2">
              <button 
                onClick={() => scrollToTop()}
                className={`transition-colors font-normal text-base ${isHomeActive ? "text-[#3481bd]" : "text-gray-700 hover:text-[#3481bd]"}`}
              >
                Início
              </button>
            ...
            >
              <button className={`flex items-center space-x-1 transition-colors font-normal text-base ${(location.pathname === "/about" || location.pathname === "/blog") ? "text-[#3481bd]" : "text-gray-700 hover:text-[#3481bd]"}`}>
                <span>Sobre Nós</span>
                <ChevronDown className="w-4 h-4" />
              </button>

              {isDropdownOpen && (
                <div className="absolute top-8 left-0 bg-white border border-gray-100 rounded-lg py-3 z-50 min-w-[160px] animate-fade-in" 
                     style={{ 
            ...
            <button
              ...
              className={`transition-colors font-normal text-base ${isServicesActive ? "text-[#3481bd]" : "text-gray-700 hover:text-[#3481bd]"}`}
            >
              Serviços
            </button>
            ...
            <button
              ...
              className={`transition-colors font-normal text-base ${isContactActive ? "text-[#3481bd]" : "text-gray-700 hover:text-[#3481bd]"}`}
            >
              Contato
            </button>
            </div>

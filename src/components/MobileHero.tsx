...
const MobileHero = ({ onOpenModal }: MobileHeroProps) => {
  return (
    <section className="relative min-h-screen bg-gray-100 md:hidden px-6 pt-20 pb-11 flex flex-col justify-between">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center -translate-y-12">
